...
public class SciffLauncher {
    ...
    public SciffLauncher(String model, String observability,
                         String durationConstr,String interTConstr,String options, Boolean debug) {
        cmd = new String[]{path_to_swipl+"/swipl", "-g", "working_directory(_,'"+path_to_AlpBPM+"'),spark_trace_verification("
    ...
    public String launch(String [] values, String lastEvent){
    ...
    public String launch(String [] values, int sm, ArrayList<String> [] eventsToMeet, String lastEvent){
        this.lastEvent= lastEvent;
        try {
            if (values.length==0) throw new IOException("The event list should never be empty at this stage!");
            ProcessBuilder pb = new ProcessBuilder(cmd);
